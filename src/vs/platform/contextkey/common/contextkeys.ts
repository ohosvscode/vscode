...
import { isIOS, isLinux, isMacintosh, isMobile, isOhos, isWeb, isWindows } from '../../../base/common/platform.js';
...
export const IsOhosContext = new RawContextKey<boolean>('isOhos', isOhos, localize('isOhos', "Whether the operating system is harmonyOS"));
